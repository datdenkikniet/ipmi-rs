...
impl ChannelAccess {
    ...
    pub fn parse(data: &[u8]) -> Option<Self> {
        ...
        let alerting_disabled = (data[0] & 0x20) != 0;
        let per_msg_auth_disabled = (data[0] & 0x10) != 0;
        let user_level_auth_disabled = (data[0] & 0x08) != 0;
...
impl core::fmt::Display for ChannelAccessMode {
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        match self {
            ...
            ChannelAccessMode::Reserved(value) => write!(f, "Reserved (0x{value:02X})"),
        }
    }
}
...
impl core::fmt::Display for ChannelPrivilegeLevel {
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        match self {
            ...
            ChannelPrivilegeLevel::ReservedValue(value) => write!(f, "Reserved (0x{value:02X})"),
        }
    }
}
